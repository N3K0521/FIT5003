...
*/
		...
		$mysqli = $this->mMySQLHandler->returnDatabaseConnection();
		// Prepare the SQL statement
		$lQueryString = "SELECT username FROM accounts WHERE username = ?";
		$statement = $mysqli->prepare($lQueryString);
		...
		$lQueryResult = $statement->get_result();
		// Close the statement
		$statement->close();//end task3
...
*/
		...
		//Task 3
		$mysqli = $this ->mMySQLHandler->returnDatabaseConnection();
                // Prepare an SQL query string using placeholders to avoid SQL injection
		...
		// Bind the provided username and password to the prepared statement's placeholders
